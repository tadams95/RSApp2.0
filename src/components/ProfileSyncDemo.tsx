    ...
    return (
      <View style={styles.statusContainer}>
        <Text style={styles.syncedText}>
          Profile synced {lastSyncTime ? new Date(lastSyncTime).toLocaleTimeString() : 'never'}
        </Text>
      </View>
    );
  };
      ...
      <View style={styles.profileContainer}>
        {profile && (
          <>
            ...
            <Text style={styles.profileValue}>{profile.displayName || 'Not set'}</Text>
            
            <Text style={styles.profileLabel}>Email:</Text>
            <Text style={styles.profileValue}>{profile.email || 'Not available'}</Text>
